...
const errorHandlingMiddleware_1 = __importDefault(require("./infrastructure/middlewares/errorHandlingMiddleware"));
...
app.use((0, cors_1.default)({
    origin: "https://eventify-frontendd-peermohammad.vercel.app",
    credentials: true,
}));
